...
machina:
	states:
		...
		'/select_mun':
			...
			render: (E) ->
				# @poetry.Verse.Mun {persona: @book.session.persona}
				# E \div null, "todo: the sulect mun process..."
		...
		'/login':
			onenter: ->
				console.log "entering Session.login ... but you already knew that"
