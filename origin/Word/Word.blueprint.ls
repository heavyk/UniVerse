...
api: (api, bp) ->
	model = bp.model
	path = api.get '/_#{bp.type}/:id' (req, res) ->
		#@collection.byExample _id: req.get \id
		r = model.byId req.params \id
...
machina:
	...
	states:
		uninitialized:
			onenter: ->
				#TODO: I'm pretty sure this logic is wrong
				console.log "Word.uninitialized", this
				console.log "initialize word", @id
				# @transition \ready
