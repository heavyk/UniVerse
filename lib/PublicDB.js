...
var Path, Fs, Url, Http, ref$, Fsm, ToolShed, _, Debug, debug, get_path, set_path, Blueprint, LocalDB, PublicDB, out$ = typeof exports != 'undefined' && exports || this;
Path = require('path');
Fs = require('fs');
Url = require('url');
Http = require('http');
...
out$.LocalDB = LocalDB = (function(superclass){
  ...
  prototype.states = {
    uninitialized: {
      onenter: function(){
        var cb, options, this$ = this;
        if (typeof options === 'function') {
          cb = options;
          options = void 8;
        }
        this.storage = new _.LargeLocalStorage(options);
        this.storage.initialized.fail(function(err){
          console.log("local storage error:", err);
          return this$.transition('error');
        });
        return this.storage.initialized.done(function(){
          if (typeof cb === 'function') {
