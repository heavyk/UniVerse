...
var Path, Fs, Url, Http, ref$, Fsm, ToolShed, Debug, DaFunk, _, debug, get_path, set_path, Blueprint, levelJs, LocalDB, PublicDB, out$ = typeof exports != 'undefined' && exports || this;
Path = require('path');
Fs = require('fs');
Url = require('url');
Http = require('http');
        ...
        onenter: function(){
          return get_bp(encantador, incantation, version, function(err, res){
            ...
            if (err) {
              ...
              deps = DaFunk.embody({}, res.elements);
