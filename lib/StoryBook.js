...
var Url, assert, Session, ref$, Fsm, ToolShed, Fabuloso, _, StoryBook, out$ = typeof exports != 'undefined' && exports || this;
Url = require('url');
      ...
      return UniVerse.library.exec('fetch', {
        ...
        return bp.once_initialized(function(){
          ...
          return this$.session.once_initialized(function(){
            var noem, sess_id, poem, fqvn;
            this$.debug("SESSION INITIALIZED.... going to imbue the poem now...");
            noem = name + '@' + version;
            ...
            this$.debug("loading poem '" + noem + "' with sess_id: " + sess_id);
