...
Meaning = (function(superclass){
  ...
  prototype.states = {
    ...
    ready: {
      ...
      validate: function(){
        this.debug.error("TODO: @validate state??");
...
Blueprint = (function(superclass){
  ...
  prototype.imbue = function(book, cb){
    var blueprint_inst, library, _bp, _deps, _blueprint, deps, i$, len$, d, bp, this$ = this;
  ...
  prototype.states = {
    ...
    ready: {
      onenter: function(){
        return console.log("we are ready @ " + this.namespace);
      },
