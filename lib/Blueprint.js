...
var assert, Http, pathToRegexp, ref$, Fsm, ToolShed, _, Machina, StoryBook, ExperienceDB, Perspective, Quest, Symbolic, Tone, Timing, Meaning, Magnetism, Blueprint, out$ = typeof exports != 'undefined' && exports || this;
assert = require('assert');
Http = require('http');
pathToRegexp = require('path-to-regexp');
ref$ = require('MachineShop'), Fsm = ref$.Fsm, ToolShed = ref$.ToolShed, _ = ref$._, Machina = ref$.Machina;
...
Timing = {
  'extend.initialize': function(){
    ...
    if (this.quests) {
      return ToolShed.extend(this.quests, this._bp._blueprint.quests);
    } else {
...
Meaning = (function(superclass){
  ...
  prototype.cmds = {
    make_new: function(erase_vals){
      if (erase_vals) {
        this._xp = ToolShed.extend({}, this._xp_tpl);
      } else {
        this._xp = ToolShed.extend({}, this._xp);
      }
      this._is_new = true;
      this._dirty_vals = {};
  ...
  prototype.states = {
    uninitialized: {
      onenter: function(){
        ...
        process_bp = function(){
          var bp, deps, long_incantation, embodies, UniVerse, book, task;
        ...
        return req = Http.get({
          path: "/db/_bp/" + this.encantador + "/" + this.incantation + (this.version && this.version !== 'latest' ? '&version=' + this.version : '')
        }, function(res){
          var data;
          ...
          res.on('end', function(){
            if (res.statusCode === 200) {
              this$._blueprint = ToolShed.objectify(data, {
